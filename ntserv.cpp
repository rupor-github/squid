...
CNTService::CNTService(_In_opt_z_ LPCTSTR lpszServiceName, _In_opt_z_ LPCTSTR lpszDisplayName, _In_ DWORD dwControlsAccepted, _In_opt_z_ LPCTSTR lpszDescription) : m_lpfnRegisterServiceCtrlHandlerEx(NULL)
{
...
void CNTService::SetServiceName(_In_opt_z_ LPCTSTR sServiceName) 
{
...
void CNTService::SetDisplayName(_In_opt_z_ LPCTSTR sDisplayName)
{ 
...
void CNTService::SetDescription(_In_opt_z_ LPCTSTR sDescription)
{ 
...
void CNTService::Initialize(_In_opt_z_ LPCTSTR lpszServiceName, _In_opt_z_ LPCTSTR lpszDisplayName, _In_ DWORD dwControlsAccepted, _In_opt_z_ LPCTSTR lpszDescription)
{
...
DWORD WINAPI CNTService::ServiceCtrlHandler(_In_ DWORD dwControl, _In_ DWORD dwEventType, _In_opt_ LPVOID lpEventData)
{
...
_Return_type_success_(return != 0) BOOL CNTService::RegisterCtrlHandler()
{
  ...
  if (m_lpfnRegisterServiceCtrlHandlerEx != NULL)
  {
  #ifdef CNTSERVICE_MFC_EXTENSIONS
...
DWORD WINAPI CNTService::_ServiceCtrlHandlerEx(_In_ DWORD dwControl, _In_ DWORD dwEventType, _In_opt_ LPVOID lpEventData, _In_opt_ LPVOID /*lpContext*/)
{
  //Validate our parameters
  ATLASSUME(sm_lpService != NULL);
...
void WINAPI CNTService::_SDKServiceMain(_In_ DWORD dwArgc, _In_opt_ LPTSTR* lpszArgv)
{
  //Validate our parameters
  ATLASSUME(sm_lpService != NULL);
...
void CNTService::_ServiceMain(_In_ DWORD dwArgc, _In_opt_ LPTSTR* lpszArgv)
{
...
_Return_type_success_(return != 0) BOOL CNTService::WriteServiceProfileString(_In_opt_z_ LPCTSTR lpszService, _In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _In_opt_z_ LPCTSTR lpszValue, _In_ BOOL bFlush, _Inout_opt_ DWORD* pLastError)
{
  //Validate our parameters
...
_Return_type_success_(return != 0) BOOL CNTService::WriteServiceProfileInt(_In_opt_z_ LPCTSTR lpszService, _In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _In_ int nValue, _In_ BOOL bFlush, _Inout_opt_ DWORD* pLastError)
{
  //Validate our parameters
  ATLASSERT(lpszService != NULL);
  ...
  if ((lResult != ERROR_SUCCESS) && (pLastError != NULL))
    *pLastError = lResult;
  if (bFlush)
    secKey.Flush();
  return lResult == ERROR_SUCCESS;
...
_Return_type_success_(return != 0) BOOL CNTService::WriteServiceProfileStringArray(_In_opt_z_ LPCTSTR lpszService, _In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _In_ const CNTServiceStringArray& array, _In_ BOOL bFlush, _Inout_opt_ DWORD* pLastError)
{
  //Validate our parameters
  ATLASSERT(lpszSection != NULL);
  ATLASSERT(lpszService != NULL);
...
_Return_type_success_(return != 0) BOOL CNTService::WriteServiceProfileBinary(_In_opt_z_ LPCTSTR lpszService, _In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _In_reads_bytes_opt_(nBytes) LPBYTE pData, _In_ ULONG nBytes, _In_ BOOL bFlush, _Inout_opt_ DWORD* pLastError)
{ 
  //Validate our parameters
  ATLASSERT(lpszSection != NULL);
  ATLASSERT(lpszService != NULL);
...
CNTServiceString CNTService::GetServiceProfileString(_In_opt_z_ LPCTSTR lpszService, _In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _In_opt_z_ LPCTSTR lpszDefault, _Inout_opt_ DWORD* pLastError)
{
  //Validate our parameters
  ATLASSERT(lpszService != NULL);
  ATLASSERT(lpszSection != NULL);
...
UINT CNTService::GetServiceProfileInt(_In_opt_z_ LPCTSTR lpszService, _In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _In_ int nDefault, _Inout_opt_ DWORD* pLastError)
{
  //Validate our parameters
  ATLASSERT(lpszService != NULL);
  ATLASSERT(lpszSection != NULL);
...
_Return_type_success_(return != 0) BOOL CNTService::GetServiceProfileStringArray(_In_opt_z_ LPCTSTR lpszService, _In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _Out_ CNTServiceStringArray& array, _Inout_opt_ DWORD* pLastError)
{
  //Validate our parameters
  ATLASSERT(lpszService != NULL);
  ATLASSERT(lpszSection != NULL);
...
_Return_type_success_(return != 0) BOOL CNTService::GetServiceProfileBinary(_In_opt_z_ LPCTSTR lpszService, _In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _Out_writes_bytes_(*pnBytes) LPBYTE* ppData, _Out_ ULONG* pnBytes, _Inout_opt_ DWORD* pLastError)
{
  //Validate our parameters
  ATLASSERT(lpszService != NULL);
  ATLASSERT(lpszSection != NULL);
...
_Return_type_success_(return != 0) BOOL CNTService::GetSectionKey(_In_ ATL::CRegKey& sectionKey, _In_opt_z_ LPCTSTR lpszServiceName, _In_opt_z_ LPCTSTR lpszSection, _In_ BOOL bReadOnly, _Inout_opt_ DWORD* pLastError)
{
  //Validate our parameters
  ATLASSERT(lpszServiceName != NULL);
  ATLASSUME(lpszSection != NULL);
...
// creating it if it doesn't exist
_Return_type_success_(return != 0) BOOL CNTService::GetServiceParametersKey(_In_ ATL::CRegKey& serviceParametersKey, _In_opt_z_ LPCTSTR lpszServiceName, _In_ BOOL bReadOnly, _Inout_opt_ DWORD* pLastError)
{
  //Validate our parameters
...
_Return_type_success_(return != 0) BOOL CNTService::WriteProfileString(_In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _In_opt_z_ LPCTSTR lpszValue)
{
#ifdef CNTSERVICE_MFC_EXTENSIONS
...
_Return_type_success_(return != 0) BOOL CNTService::WriteProfileInt(_In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _In_ int nValue)
{
#ifdef CNTSERVICE_MFC_EXTENSIONS
...
_Return_type_success_(return != 0) BOOL CNTService::WriteProfileStringArray(_In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _In_ const CNTServiceStringArray& array)
{
#ifdef CNTSERVICE_MFC_EXTENSIONS
...
_Return_type_success_(return != 0) BOOL CNTService::WriteProfileBinary(_In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _In_reads_bytes_opt_(nBytes) LPBYTE pData, _In_ UINT nBytes)
{
#ifdef CNTSERVICE_MFC_EXTENSIONS
...
CNTServiceString CNTService::GetProfileString(_In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _In_opt_z_ LPCTSTR lpszDefault, _Inout_opt_ DWORD* pLastError)
{
#ifdef CNTSERVICE_MFC_EXTENSIONS
...
UINT CNTService::GetProfileInt(_In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _In_ int nDefault, _Inout_opt_ DWORD* pLastError)
{
#ifdef CNTSERVICE_MFC_EXTENSIONS
...
_Return_type_success_(return != 0) BOOL CNTService::GetProfileStringArray(_In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _Out_ CNTServiceStringArray& array)
{
#ifdef CNTSERVICE_MFC_EXTENSIONS
...
_Return_type_success_(return != 0) BOOL CNTService::GetProfileBinary(_In_opt_z_ LPCTSTR lpszSection, _In_opt_z_ LPCTSTR lpszEntry, _Out_writes_bytes_(*pnBytes) LPBYTE* ppData, _Out_ ULONG* pnBytes)
{
  //Validate our parameters
  ATLASSUME(pnBytes != NULL);
  *pnBytes = 0;
...
_Return_type_success_(return != 0) BOOL CNTService::InstallEventLogSource(_Inout_ CNTServiceString& sErrorMsg, _Inout_ DWORD& dwError)
{
...
#endif //#ifdef CNTSERVICE_MFC_EXTENSIONS
  {
    ...
    _tcscat_s(szFname, sizeof(szFname)/sizeof(TCHAR), _T("Msg"));
...
_Return_type_success_(return != 0) BOOL CNTService::EnableServiceLogonRight(_Inout_ CNTServiceString& sErrorMsg, _Inout_ DWORD& dwError)
{
  ...
  SID_NAME_USE snu;
#ifdef CNTSERVICE_MFC_EXTENSIONS
  LookupAccountName(NULL, m_sUserName, NULL, &dwSIDSize, NULL, &dwDomainNameSize, &snu);
#else
  LookupAccountName(NULL, m_sUserName.c_str(), NULL, &dwSIDSize, NULL, &dwDomainNameSize, &snu);
#endif //#ifdef CNTSERVICE_MFC_EXTENSIONS
  if (dwSIDSize)
  {
...
#ifdef CNTSERVICE_MFC_EXTENSIONS
    if (!LookupAccountName(NULL, m_sUserName, sid.m_pData, &dwSIDSize, domain.m_pData, &dwDomainNameSize, &snu))
#else
    if (!LookupAccountName(NULL, m_sUserName.c_str(), sid.m_pData, &dwSIDSize, domain.m_pData, &dwDomainNameSize, &snu))
#endif //#ifdef CNTSERVICE_MFC_EXTENSIONS
    {
      dwError = GetLastError();
    ...
    NTSTATUS ntStatus = LsaOpenPolicy(NULL, &attributes, POLICY_LOOKUP_NAMES | POLICY_CREATE_ACCOUNT, &lsaHandle);
    ...
    wchar_t* pszPrivilege = L"SeServiceLogonRight";
    userRights.Buffer = pszPrivilege;
...
void CNTService::FormatString(_In_ CNTServiceString& sMsg, _In_ UINT nIDS, _In_opt_z_ LPCTSTR psz1)
{
#ifdef CNTSERVICE_MFC_EXTENSIONS
...
void CNTService::FormatString(_In_ CNTServiceString& sMsg, _In_ UINT nIDS, _In_opt_z_ LPCTSTR psz1, _In_opt_z_ LPCTSTR psz2)
{
#ifdef CNTSERVICE_MFC_EXTENSIONS
